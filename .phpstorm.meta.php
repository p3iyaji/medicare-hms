...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Applications/XAMPP/xamppfiles/htdocs/medicals/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./Applications/XAMPP/xamppfiles/htdocs/medicals/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'dompdf.options.allowed_remote_hosts','dompdf.options.font_height_ratio','dompdf.options.enable_html5_parser','debugbar.enabled','debugbar.collect_jobs',
...
'sanctum.csrf-cookie','deactivated','dashboard',
'profile.edit','profile.update','profile.delete','profile.phone.update','profile.password.update',
'profile.photo.update','profile.photo.destroy',
'profile.export.pdf','profile.forms','profile.forms.download.complete','profile.forms.download.compact','medical-records.index',
'patients','patients.create','patients.deactivate','patients.activate','patients.store',
'patients.edit','patients.update','patients.destroy','doctors','doctors.create',
'doctors.store','doctors.edit','doctors.update','doctors.destroy','doctors.deactivate',
'doctors.activate','specializations','specializations.create','specializations.store','specializations.edit',
'specializations.update','specializations.destroy','schedules','schedules.create','schedules.store',
'schedules.edit','schedules.update','schedules.destroy','schedule-exceptions','schedule-exceptions.create',
'schedule-exceptions.store','schedule-exceptions.edit','appointments','appointments.create','appointments',
'appointments.edit','appointments.update','appointments.destroy','appointments.vitals','vitals.create',
'vitals.store','patients.vitals','doctor.appointments','settings','billing.index',
'reports.index','register','login',
...
'app','pdf.blank-profile-form','pdf.blank-profile-form-compact','pdf.profile','laravel-exceptions-renderer::components.badge',
