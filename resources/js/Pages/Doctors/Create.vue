...
const genders = usePage().props.medical.genders;
const titles = usePage().props.medical.titles;
const religions = usePage().props.medical.religions;
const bloodTypes = usePage().props.medical.blood_types;
                        ...
                        >
                            ...
                            <div class="space-y-1">
                                ...
                                <TextInput
                                    ...
                                    readonly
                                    type="email"
                                    class="w-full text-sm sm:text-base text-gray-500 bg-gray-100 cursor-not-allowed"
                                />
                                <TextInput
                                    v-else
                                    id="email"
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <div class="relative w-full">
                                            <TextInput
                                                ...
                                                "
                                                required
                                                class="w-full pr-10 text-sm sm:text-base"
                                            />
