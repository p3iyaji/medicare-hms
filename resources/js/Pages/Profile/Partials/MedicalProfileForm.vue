...
const form = useForm({
    ...
    allergies_text: props.profile.allergies
        ? props.profile.allergies.join("\n")
        : "",
    chronic_conditions_text: props.profile.chronic_conditions
        ? props.profile.chronic_conditions.join("\n")
        : "",
});
...
const startEditing = () => {
    ...
    form.allergies_text = props.profile.allergies
        ? props.profile.allergies.join("\n")
        : "";
    form.chronic_conditions_text = props.profile.chronic_conditions
        ? props.profile.chronic_conditions.join("\n")
        : "";
    form.clearErrors();
};
...
const submitForm = () => {
    ...
    const formData = {
        ...
        allergies: form.allergies_text
            ...
            : [],
        chronic_conditions: form.chronic_conditions_text
            ? form.chronic_conditions_text
                  .split("\n")
                  .filter((item) => item.trim() !== "")
            : [],
    };
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            :class="{
                                'border-red-300': form.errors.blood_type,
                            }"
                        >
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <TextInput
                                ...
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                :class="{
                                    'border-red-300': form.errors.height,
                                }"
                            />
                            <p
                        ...
                        <div>
                            ...
                            <TextInput
                                ...
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                                :class="{
                                    'border-red-300': form.errors.weight,
                                }"
                            />
                            <p
                    ...
                    <div>
                        ...
                        <p
                            v-if="form.errors.primary_physician_id"
                            class="mt-1 text-sm text-red-600"
                        >
                            {{ form.errors.primary_physician_id }}
                        </p>
...
Latex"
                    ...
                    <div>
                        <InputLabel
                            for="chronic_conditions"
                            value="Chronic conditions (one per line)"
                        />
...
Asthma"
                        ></textarea>
                        <p
                            v-if="form.errors.chronic_conditions"
                            class="mt-1 text-sm text-red-600"
                        >
                            {{ form.errors.chronic_conditions }}
                        </p>
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    >
                    <div
                        v-if="profile.primary_physician_id"
                    ...
                    >
                        ...
                        <div class="ml-3">
                            <div class="font-medium text-gray-900">
                                Dr.
                                {{
                                    profile.primary_physician?.name ||
                                    "Physician"
                                }}
                            </div>
            ...
            <div class="space-y-6">
                <div>
                    ...
                    >
                    <div
                        v-if="profile.allergies && profile.allergies.length"
