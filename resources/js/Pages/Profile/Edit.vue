    ...
    <AppLayout>
        ...
        <div class="py-6 sm:py-8">
            <div class="mx-auto max-w-7xl px-3 sm:px-4 sm:px-6 lg:px-8">
                   <div class="flex flex-col sm:flex-row sm:items-center mb-4 justify-end gap-3 sm:gap-0">
                ...
                <div class="bg-white rounded-xl shadow-lg overflow-hidden mb-6 sm:mb-8">
                    <div class="bg-gradient-to-r from-blue-600 to-teal-500 px-4 sm:px-6 py-6 sm:py-8">
                        <div class="flex flex-col sm:flex-row sm:items-center gap-4">
                            <div class="flex-shrink-0 self-center sm:self-auto">
                                <div class="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-white flex items-center justify-center shadow-lg">
                                    <svg v-if="!user.profile_image" class="w-8 h-8 sm:w-10 sm:h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="text-white text-center sm:text-left">
                                ...
                                <p class="text-blue-100 truncate">{{ user.email }}</p>
                                <div class="mt-2 flex flex-wrap justify-center sm:justify-start gap-2">
                                    <span class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-blue-800 bg-opacity-50">
                                        {{ user.user_type?.replace('_', ' ') || 'Medical Professional' }}
                                    </span>
                                    <span v-if="user.is_verified" class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-green-800 bg-opacity-50">
                                        <svg class="w-3 h-3 sm:w-4 sm:h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                        </svg>
                                        Verified
                                    </span>
                                    <span v-if="user.mfa_enabled" class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-purple-800 bg-opacity-50">
                ...
                <div class="mb-6 sm:mb-8">
                    <div class="border-b border-gray-200">
                        <nav class="-mb-px flex space-x-2 sm:space-x-8 overflow-x-auto pb-1">
                            <button
                            ...
                            >
                                <svg class="w-4 h-4 sm:w-5 sm:h-5 inline-block mr-1 sm:mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                            ...
                            >
                                ...
                                <span class="hidden sm:inline">Medical Profile</span>
                ...
                <div class="space-y-6 sm:space-y-8">
                    ...
                    <div v-show="activeTab === 'personal'" class="space-y-6">
                        ...
                        <div class="bg-gradient-to-r from-blue-50 to-teal-50 rounded-xl shadow-sm p-4 sm:p-6">
                            <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
                                <div class="mb-3 sm:mb-0">
                                    <h3 class="text-lg font-semibold text-gray-900">Personal Information</h3>
                                    <p class="text-sm text-gray-600 mt-1">Manage your personal details</p>
                                </div>
                        ...
                        <div class="space-y-6 lg:grid lg:grid-cols-3 lg:gap-6">
                            ...
                            <div class="lg:col-span-2 space-y-6">
                                ...
                                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gradient-to-r from-green-50 to-white">
                                        <h4 class="text-base font-semibold text-gray-900 flex items-center">
                                                ...
                                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
                                                    <div class="flex-1 min-w-0">
                                                        <div class="flex items-center mb-1">
                                                            ...
                                                            <label class="text-sm font-medium text-gray-700 truncate">Email Address</label>
                                                        </div>
                                                        <div class="text-gray-900 font-medium truncate" :title="user.email">{{ user.email }}</div>
                                                    </div>
                            ...
                            <div class="space-y-6">
                                <!-- Profile Image Card -->
                                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gradient-to-r from-purple-50 to-white">
                                        <h4 class="text-base font-semibold text-gray-900 flex items-center">
                                ...
                                <!-- Account Status Card -->
                                <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-white">
                                        <h4 class="text-base font-semibold text-gray-900 flex items-center">
                                            <svg class="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <div class="p-4 sm:p-6">
                                        <div class="space-y-3 sm:space-y-4">
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div class="flex items-center min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <div class="text-sm font-medium text-gray-700 truncate">Account Status</div>
                                                        <div class="text-xs text-gray-500 truncate">Current account state</div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div class="flex items-center min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <div class="text-sm font-medium text-gray-700 truncate">User Type</div>
                                                        <div class="text-xs text-gray-500 truncate">Role in the system</div>
                                                    </div>
                                                </div>
                                                <span class="ml-2 inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-blue-100 text-blue-800 flex-shrink-0 truncate max-w-[120px]">
                                                    {{ user.user_type_label || user.user_type?.replace('_', ' ') || 'User' }}
                                                </span>
                                            </div>
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div class="flex items-center min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <div class="text-sm font-medium text-gray-700 truncate">Two-Factor Auth</div>
                                                        <div class="text-xs text-gray-500 truncate">Extra security layer</div>
                                                    </div>
                                                </div>
                                                <span v-if="user.mfa_enabled" 
                                            ...
                                            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                                <div class="flex items-center min-w-0">
                                                    ...
                                                    <div class="min-w-0">
                                                        <div class="text-sm font-medium text-gray-700 truncate">Last Login</div>
                                                        <div class="text-xs text-gray-500 truncate">Recent account activity</div>
                                                    </div>
                                                </div>
                                                <div class="text-right flex-shrink-0 ml-2">
                                                    ...
                                                    <div v-if="user.last_login_at" class="text-xs text-gray-500 truncate">
                                        ...
                                        <div class="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                                            <h5 class="text-sm font-medium text-gray-900 mb-2 sm:mb-3">Quick Actions</h5>
                    ...
                    <!-- Medical Profile Tab -->
                    <div v-show="activeTab === 'medical'" class="bg-white rounded-xl shadow-sm sm:shadow-lg p-4 sm:p-6">
                        <MedicalProfileForm 
                            :profile="profile"
                    ...
                    <div v-show="activeTab === 'emergency'" class="bg-white rounded-xl shadow-sm sm:shadow-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Emergency Contact Information</h3>
                    ...
                    <!-- Insurance Tab -->
                    <div v-show="activeTab === 'insurance'" class="bg-white rounded-xl shadow-sm sm:shadow-lg p-4 sm:p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Insurance Information</h3>
                        <HealthInsurance 
                            :profile="profile"
                    ...
                    <div v-show="activeTab === 'security'" class="space-y-4 sm:space-y-6">                       
                        <!-- Update Password -->
                        <div class="bg-white rounded-xl shadow-sm sm:shadow-lg p-4 sm:p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Security Settings</h3>
                            <UpdatePasswordForm />
                            
                            <!-- Two-Factor Authentication -->
                            <div class="mt-6 sm:mt-8 pt-4 sm:pt-8 border-t border-gray-200">
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                    ...
                                    <div class="flex-shrink-0">
                                        <span v-if="user.mfa_enabled" class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-green-100 text-green-800">
                                            <svg class="w-3 h-3 sm:w-4 sm:h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
                                            </svg>
                                            Enabled
                                        </span>
                                        <span v-else class="inline-flex items-center px-2 py-1 sm:px-3 sm:py-1 rounded-full text-xs sm:text-sm font-medium bg-gray-100 text-gray-800">
                                            Disabled
                                        </span>
                                    </div>
                                </div>
