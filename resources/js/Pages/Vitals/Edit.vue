...
// Form state
const form = useForm({
    appointment_id: props.vitalSign.appointment_id || null,
            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">
                        ...
                        {{ patient.last_name }} ({{ patient.patient_no }})
                    </p>
                </div>
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <div class="flex flex-col items-end">
                                        ...
                                        <button
                                            ...
                                            "
                                            class="px-3 py-1 text-xs bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
                                        >
                                            {{
                                                device.status === "available"
                                                    ? "Connect"
