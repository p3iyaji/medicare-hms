...
<template>
    ...
    <div
        class="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col"
    >
        <!-- Background Medical Image -->
        <div class="fixed inset-0 z-0 overflow-hidden">
            <div
                class="absolute inset-0 bg-gradient-to-r from-blue-900/20 to-teal-900/10"
            ></div>
            <img
            ...
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center">
                    <a href="/" class="flex items-center">
                        <div
                            class="w-8 h-8 bg-blue-600 rounded-lg flex items-center justify-center shadow"
                        >
                            <svg
        ...
        >
            <div class="w-full max-w-lg">
                ...
                <div class="relative">
                    ...
                    <div
                        class="absolute -inset-1 bg-gradient-to-r from-blue-500 to-teal-400 rounded-2xl blur opacity-20"
                    ></div>

                    <!-- Main Card -->
                    <div
                        class="relative bg-white rounded-xl shadow-xl p-8 border border-gray-100"
                    >
                        <!-- Logo and Title -->
                        <div class="text-center mb-8">
                            ...
                            <p class="mt-2 text-sm text-gray-600">
                                Join thousands of medical professionals using
                                MediCare Pro
                            </p>
                        </div>
                        ...
                        <form @submit.prevent="submit" class="space-y-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        class="pl-10 w-full border border-gray-300 rounded-lg bg-gray-50 px-3 py-2.5 text-gray-700"
                                    >
                                        <span class="font-medium"
                                            >Patient Account</span
                                        >
                                        <span class="text-sm text-gray-500 ml-2"
                                            >(Standard medical profile)</span
                                        >
                                    </div>
                                </div>
                                <p class="mt-1 text-xs text-gray-500">
                                    All new registrations are created as Patient
                                    accounts
                                </p>
                            </div>
                         ...
                         c4.478 0 8.268 2.943 9.542 7
                         a9.98 9.98 0 01-4.043 5.568M15 12
                         a3 3 0 11-6 0 3 3 0 016 0z"
                            ...
                            <div class="pt-4">
                                <PrimaryButton
                                    class="w-full justify-center py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 border-transparent text-white font-medium rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
        ...
        <footer class="relative z-10 py-4">
            <div class="max-w-7xl mx-auto px-4">
                <p class="text-center text-xs text-gray-500">
                    &copy; 2026 MediCare Pro. For authorized medical
                    professionals only.
                </p>
            </div>
        </footer>
